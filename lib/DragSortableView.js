...
import { Animated, Dimensions, Easing, PanResponder, StyleSheet, TouchableOpacity, View, Platform, PixelRatio } from "react-native";
                    ...
                    return (
                        ...
                        >
                            <TouchableOpacity
                                ...
                                style={
                                    this.state && this.state.seletedIndex == index
                                        ? {
                            ...
                            >
                                {this.props.renderItem(item.data, index, {
                                    backgroundColor:
                                        this.state && this.state.seletedIndex == index && Platform.OS == "android" ? "#e5e5e5" : "white"
                                })}
                            </TouchableOpacity>
                        </Animated.View>
                    );
